...
def main():
    ...
    client = pymongo.MongoClient("mongodb://Tanishq:tanishq123@docdb-2024-08-03-05-45-20.couv5phowwot.us-east-2.docdb.amazonaws.com:27017/?tls=true&tlsCAFile=global-bundle.pem&retryWrites=false")#(clusterendpoint, username=username, password=password, tls='true', tlsCAFile='rds-combined-ca-bundle.pem',retryWrites='false')
